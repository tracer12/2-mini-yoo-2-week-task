public class Constants {
    ...
    public static final String PRODUCT_LIST_COLUMNS = "재고        가격        수량";
    ...
    public static final String INVALID_QUANTITY = "재고가 부족하거나 유효하지 않은 수량입니다.";
    public static final String PROCEED_PURCHASE = "계산을 진행하시겠습니까? Y/N: ";
    public static final String INVALID_INPUT = "잘못된 입력입니다, 다시 입력해주세요.(Y/N)";
    public static final String ENTER_AMOUNT = "금액을 입력해주세요.";
    public static final String INSUFFICIENT_FUNDS = "금액이 부족합니다. 다시 입력해 주세요.";
